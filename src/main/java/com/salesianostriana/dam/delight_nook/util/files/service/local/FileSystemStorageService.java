...
import com.salesianostriana.dam.delight_nook.util.files.exception.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    private String store(byte[] file, String filename, String contentType) throws Exception {
        ...
        try (InputStream inputStream = new ByteArrayInputStream(file)) {
            Files.copy(inputStream, load(newFilename),
    ...
    private String calculateNewFilename(String filename) {
        ...
        while(Files.exists(load(newFilename))) {
